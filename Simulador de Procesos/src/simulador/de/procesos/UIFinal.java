...
public class UIFinal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaParticiones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Tam Proceso", "Tam Particion", "Fragmentación"
            }
        ) {
            Class[] types = new Class [] {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(42, 42, 42)
                        .addComponent(botonSiguiente, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public final void cargarParticiones(){
        ...
        while (it.hasNext()) {
            ...
            if (part.isEstado() == false){              //Si la particion esta ocupada entra
                ...
                tabla[2]= part.Tamaño();
                tabla[3]= part.Tamaño()- process.getTamaño();
                modelo.addRow(tabla);
                if (!process.isES()){
